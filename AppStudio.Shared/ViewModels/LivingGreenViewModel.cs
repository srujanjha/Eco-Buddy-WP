...
{
    public class LivingGreenViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "LivingGreenDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new LivingGreenDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("LivingGreenDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("LivingGreenList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("LivingGreenDetail");
        }
    }
}
