...
{
    public class EnvironmentMattersViewModel : ViewModelBase<YouTubeSchema>
    {
        override protected string CacheKey
        {
            get { return "EnvironmentMattersDataSource"; }
        }

        override protected IDataSource<YouTubeSchema> CreateDataSource()
        {
            return new EnvironmentMattersDataSource(); // YouTubeDataSource
        }
        ...
        {
            base.PinToStart("EnvironmentMattersDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("EnvironmentMattersList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("EnvironmentMattersDetail");
        }
    }
}
