...
{
    public class EnvironemtalNewsViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "EnvironemtalNewsDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new EnvironemtalNewsDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("EnvironemtalNewsDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("EnvironemtalNewsList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("EnvironemtalNewsDetail");
        }
    }
}
